...
static struct dvfs cpu_0_dvfs_table[] = {
	...
	CPU_DVFS("cpu_0",  4, 3, MHZ, 475, 475, 640, 640, 640, 760, 760, 860, 860,  860,  860, 1000, 1000, 1000, 1100, 1100, 1100, 1100, 1200, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1550, 1550),
#else
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    1, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  520000,  520000,  520000),
#else
...
#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  520000,  520000,  520000),
#else
